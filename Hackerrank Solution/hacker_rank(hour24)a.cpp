...
//    begin = clock();
    ...
    while (cin >> n)
    {
        ...
        fr(i, 0, s.size())
        {
            ...
            if (isdigit(s[i]))
                ud = 1;
            if ((isupper(s[i]) == 0) and (islower(s[i]) == 0) and (isdigit(s[i]) == 0))
                ua = 1;
        }
        ...
        if (s.size() >= 6)
        {
            ...
            if (uf and ul and ua and ud)
                cout << 0 << endl;
            else if ((uf and ul and ua and !ud) or (ul and ua and ud and !uf) or (ua and ud and uf and !ul) or (ud and ul and uf and !ua))
                cout << 1 << endl;
            else if ((uf and ul and !ua and !ud) or (ul and ua and !ud and !uf) or (ua and ud and !uf and !ul) or (ud and ul and !uf and !ua))
                cout << 2 << endl;
            else if ((uf and !ul and !ua and !ud) or (ul and !ua and !ud and !uf) or (ua and !ud and !uf and !ul) or (ud and !ul and !uf and !ua))
