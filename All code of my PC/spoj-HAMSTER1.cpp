...
#define ppc(x,y) cout<<setprecision(y)<<x<<fixed
...
///----------------------Main Code-------------------------------------///
double fun(double t, double v, double x, double y)
{
    double r = v * v * sin(2 * t) / 10.0;
    double h = v * v * sin(t) * sin(t) / 20.0;
    //  bug(r*x+h*y);
    return r * x + h * y;
}
