...
#define intersect(v,v1,v2)  (v2.resize(set_intersection (v.begin(),v.end(),v1.begin(),v1.end(), v2.begin())-v2.begin()))               /* vector */ /* sorted*/
#define diff(v,v1,v2)       (v2.resize(set_difference(v.begin(),v.end(),v1.begin(),v1.end(), v2.begin())-v2.begin()))                 /* vector */ /* sorted*/
#define symmdiff(v,v1,v2)    (v2.resize(set_symmetric_difference(v.begin(),v.end(),v1.begin(),v1.end(), v2.begin())-v2.begin()))      /* vector */ /* sorted*/
#define union(v,v1,v2)      (v2.resize(set_union(v.begin(),v.end(),v1.begin(),v1.end(), v2.begin())-v2.begin()))                    /* vector */ /* sorted*/
...
//    begin = clock();
    ...
    while (cin >> n>>m)
    {
        vll v,v1,v2(n+m),v3(n+m),v4(n+m),v5(n+m);
        fr(i,0,n)
        cin>>x,v.pb(x);
        fr(i,0,n)
        cin>>x,v1.pb(x);
