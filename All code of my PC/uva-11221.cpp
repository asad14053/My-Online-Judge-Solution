    ...
    while(t--)
    {
      ...
      s="";
        ...
        fr(i,0,s.size())
          ...
          //  bug(s1);
            if(x!=sqrt(l))
                cout<<"Case #"<<c++<<":"<<endl<<"No magic :("<<endl;
            else
            {
                s="";
                fr(i,0,x)
            ...
            //    bug1(s,s2);
             //   bug1(s3,s4);
                reverse(all(s3));
                reverse(all(s4));
                 if(s==s2 and s2==s3 and s3==s4)
                    cout<<"Case #"<<c++<<":"<<endl<<x<<endl;
                else cout<<"Case #"<<c++<<":"<<endl<<"No magic :("<<endl;
            }
    }
